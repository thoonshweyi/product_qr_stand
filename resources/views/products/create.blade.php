            ...
            <p id="workflow-selection-error" class="mt-2 hidden text-xs font-medium text-red-600 dark:text-red-400">Please select a workflow.</p>
                        ...
                        <div id="online-date-field" class="hidden lg:col-span-3">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="online_date" id="online_date" value="{{ old('online_date') }}" min="{{ $minimumOnlineDate }}" autocomplete="off" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Choose month and year">
                            </div>
                ...
                <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="grid gap-5 p-5 sm:p-6">
                        <div>
                            ...
                            <textarea name="description" id="description" rows="6" maxlength="2000" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm leading-6 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="{{ $defaultDescriptionMm }}" >{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description_en" id="description_en" rows="6" maxlength="2000" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm leading-6 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="{{ $defaultDescriptionEn }}">{{ old('description_en') }}</textarea>
                        </div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div class="col-span-2">
                                ...
                                <label for="main_image" class="group relative flex aspect-[3/2] cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-primary-500 hover:bg-primary-50 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:border-primary-500 dark:hover:bg-gray-700">
                                    ...
                                    <button type="button" id="main-image-remove" data-input="main_image" data-type="main" class="remove-selected-image absolute right-2 top-2 hidden h-7 w-7 items-center justify-center rounded-full border border-white/70 bg-white/90 text-red-600 opacity-0 shadow-lg shadow-gray-900/15 backdrop-blur transition hover:scale-105 hover:bg-red-50 hover:text-red-700 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-300 group-hover:opacity-100 dark:border-gray-700/80 dark:bg-gray-900/85 dark:text-red-400 dark:hover:bg-red-950/80" aria-label="Remove selected main image">
                            ...
                            <div>
                                ...
                                <label for="thumbnail_image" class="group relative flex aspect-square cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-primary-500 hover:bg-primary-50 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:border-primary-500 dark:hover:bg-gray-700">
                                    <img id="thumbnail-image-preview" class="hidden h-full w-full object-contain object-left" alt="Thumbnail image preview">
                                    ...
                                    <button type="button" id="thumbnail-image-remove" data-input="thumbnail_image" data-type="thumbnail" class="remove-selected-image absolute right-2 top-2 hidden h-7 w-7 items-center justify-center rounded-full border border-white/70 bg-white/90 text-red-600 opacity-0 shadow-lg shadow-gray-900/15 backdrop-blur transition hover:scale-105 hover:bg-red-50 hover:text-red-700 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-300 group-hover:opacity-100 dark:border-gray-700/80 dark:bg-gray-900/85 dark:text-red-400 dark:hover:bg-red-950/80" aria-label="Remove selected thumbnail image">
                                        <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"/></svg>
                                    </button>
                        ...
                        <div class="mt-5 border-t border-gray-200 pt-5 dark:border-gray-700">
                            ...
                            <label for="brand_icon" class="group relative flex h-28 w-28 cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-primary-500 hover:bg-primary-50 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:border-primary-500 dark:hover:bg-gray-700">
                                ...
                                <button type="button" id="brand-icon-image-remove" data-input="brand_icon" data-type="brand-icon" class="remove-selected-image absolute right-2 top-2 hidden h-7 w-7 items-center justify-center rounded-full border border-white/70 bg-white/90 text-red-600 opacity-0 shadow-lg shadow-gray-900/15 backdrop-blur transition hover:scale-105 hover:bg-red-50 hover:text-red-700 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-red-300 group-hover:opacity-100 dark:border-gray-700/80 dark:bg-gray-900/85 dark:text-red-400 dark:hover:bg-red-950/80" aria-label="Remove selected brand icon">
                                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18 18 6M6 6l12 12"/></svg>
                                </button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        function clearSelectedImage(inputId, type) {
            $(`#${inputId}`).val('');
        ...
        $('.remove-selected-image').on('click', function (event) {
            ...
            clearSelectedImage($(this).data('input'), $(this).data('type'));
        });
