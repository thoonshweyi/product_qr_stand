    ...
    <div class="border-b border-gray-200 bg-white px-4 py-5 dark:border-gray-700 dark:bg-gray-800 sm:px-6">
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Update product details, images and product specifications.</p>
            </div>
            <div class="flex flex-wrap items-center gap-3">
                <a href="{{ route('products.print-preview', $product) }}" target="_blank" rel="noopener" title="Preview saved product details" class="inline-flex w-fit items-center rounded-lg bg-primary-700 px-4 py-2 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-800">
            ...
            <div class="space-y-6 lg:col-span-8">
                <section class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <div class="grid gap-5 p-5 sm:grid-cols-2 sm:p-6 lg:grid-cols-6">
                        ...
                        <div id="online-date-field" class="order-last {{ $workflowHasOnline ? '' : 'hidden' }} lg:col-span-3">
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <select name="status_id" id="status" required class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                ...
                                @foreach ($statuses as $status)
                                    <option value="{{ $status->id }}" @selected((string) old('status_id', $product->status_id) === (string) $status->id)>{{ $status->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $product->name) }}" required class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Enter product display name">
                        </div>
                        ...
                        <div class="sm:col-span-2 lg:col-span-6">
                            ...
                            <input type="text" name="product_name" id="product_name" value="{{ old('product_name', $product->product_name) }}" required class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Enter a clear product name" readonly>
                        </div>
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <input type="text" name="brand" id="brand" list="brand-options" value="{{ old('brand', $product->brand) }}" required class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="Enter brand name" readonly>
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <input type="text" name="model" id="model" value="{{ old('model', $product->model) }}" required class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="e.g. ADGP-370B">
                        </div>
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <select name="country_of_origin" id="country" required class="w-full block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{ $country->id }}" @selected((string) old('country_of_origin', $product->country_of_origin) === (string) $country->id)>{{ $country->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid gap-5 p-5 sm:p-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="url" name="website_url" id="website_url" value="{{ old('website_url', $product->website_url) }}" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white" placeholder="https://example.com/product/...">
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <label for="thumbnail_image" class="group relative flex aspect-square cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-primary-500 hover:bg-primary-50 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:border-primary-500 dark:hover:bg-gray-700">
                                    <img id="thumbnail-image-preview" @if($product->thumbnail) src="{{ asset($product->thumbnail) }}" @endif class="{{ $product->thumbnail ? '' : 'hidden' }} h-full w-full object-contain object-left" alt="Thumbnail image preview">
                                    <div id="thumbnail-image-placeholder" class="{{ $product->thumbnail ? 'hidden' : '' }} p-2 text-center">
                        ...
                        <div class="mt-5 border-t border-gray-200 pt-5 dark:border-gray-700">
                            ...
                            <label for="brand_icon" class="group relative flex h-28 w-28 cursor-pointer items-center justify-center overflow-hidden rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 transition hover:border-primary-500 hover:bg-primary-50 dark:border-gray-600 dark:bg-gray-700/50 dark:hover:border-primary-500 dark:hover:bg-gray-700">
                                <img id="brand-icon-image-preview" @if($product->brand_icon) src="{{ asset($product->brand_icon) }}" @endif class="{{ $product->brand_icon ? '' : 'hidden' }} h-full w-full object-contain p-2" alt="Brand icon preview">
                                <div id="brand-icon-image-placeholder" class="{{ $product->brand_icon ? 'hidden' : '' }} p-2 text-center">
                                    <svg class="mx-auto mb-1.5 h-6 w-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 4v16m8-8H4"/></svg>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const requiresOnlineDate = selectedWorkflowSlug.includes('online');
        ...
        let rows = (@js(old('specifications', $initialSpecifications)) || [])
        ...
        function ensureFixedWorkflowSpecifications() {
            fixedRequiredSpecifications().forEach(name => {
                ...
                if (!rows.some(row => normalize(row.name) === normalize(name))) {
            ...
            $('#specification-rows').html(rows.map((row, index) => {
                ...
                <div class="grid gap-2 border-t border-gray-100 px-4 py-3 first:border-t-0 dark:border-gray-700 sm:grid-cols-12 sm:items-center" data-row-id="${row.id}">
                    <div class="sm:col-span-5">
                        ...
                        ${fixed
                            ? `<input type="hidden" name="specifications[${index}][name]" value="${escapeHtml(row.name)}"><div class="flex min-h-[42px] items-center justify-between rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-800 dark:border-blue-800 dark:bg-blue-900/30 dark:text-blue-200"><span>${escapeHtml(row.name)}</span><span class="text-[10px] font-bold uppercase tracking-wide text-blue-500">Required</span></div>`
        ...
        $('#product_code').on('blur', async () => {
            ...
            if (product_code === initialProductCode) {
                return;
            }
        ...
        // Start Product Save
            ...
            $('#product-edit-form').on('submit', function (event) {
                ...
                //     $button.prop('disabled', false);
                //     $('#update-product-button-label').text('Create product');
                // });
                ...
                Swal.fire({
                    ...
                    if(result.isConfirmed)
                    {
                        ...
                        $('#update-product-button-label').text('Updating...');
