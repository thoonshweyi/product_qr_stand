                ...
                <nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <div class="px-3 py-3 lg:px-5 lg:pl-3">
                        ...
                        <div class="flex items-center justify-start">
                            ...
                            <img src="{{ asset('assets/img/fav/myfav.png') }}" class="h-8 mr-3" alt="Product QR Stand Logo" />
                            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Product QR Stand</span>
                            </a>
