                ...
                <nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <div class="px-3 py-3 lg:px-5 lg:pl-3">
                        ...
                        <div class="flex items-center justify-start">
                            ...
                            <img src="{{ asset('assets/img/fav/myfav.png') }}" class="h-8 mr-3" alt="Product Information Logo" />
                            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Product Information</span>
                            </a>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="flex items-center ml-3">
                                ...
                                <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                                    ...
                                    <div class="w-8 h-8 rounded-full bg-red-600 flex justify-center items-center !text-white">{{ $userdata->avatar }}</div>
                                </button>
                                </div>
                                <!-- Dropdown menu -->
                                ...
                                <ul class="py-1" role="none">
                                    ...
                                    <li>
                                    <a href="javascript:void(0);" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">Sign out</a>
